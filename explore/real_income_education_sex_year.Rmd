...
makeFootnote("Source: ABS cat. 6543.0, 6541.0, 6503.0. Author's calculations.")
```
...
ggplot(prsqs_long, aes(y=PRsq, x=Year, colour=variable)) + geom_line() +
    geom_point() +
    ggtitle("Explanatory power of Education and Sex in Mean Log Real Earnings") +
...
ggplot(ed_prop, aes(x=EducA, y=wsum, fill=Year, colour=Year)) + 
