...
curf <- data.frame(read.spss('data/curf/1997/IDS96PSN.SAV'))
...
subset_1997 <- subs[,c("ID", "Year", "SEXP", "Age4",
                       "IEARNCP","IEARNPP",
...
colnames(subset_1997) <- standard_column_list

save(subset_1997, file='data/curf/1997.rda')
