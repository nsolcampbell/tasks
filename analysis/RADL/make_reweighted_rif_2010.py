...
if mapping == 1:
    ...
    grpvar  = "COMBINEDI"
    latent  = """generate tstar_i = -1.004331 * expdum1 -.5248388 * expdum2  ///
    ...
    densityfile = "../../data/density/2010.csv"
else:
    mapfile = "Combined2Map"
    grpvar  = "COMBINEDII"
    latent = """generate tstar_ii = .0739616 * expdum1 + .1186636 * expdum2 ///
...
print """* compute probability of being in period 1, based on pre-computed probit model
* computed in RADL"""
print latent
print """
...
import csv
with open(densityfile, 'rb') as csvfile:
