...
\begin{figure}
  ...
  \caption{Mean occupational wage and task measure index values, at ANZSCO unit group (4-digit) level. Census respondents reporting full-time work are shown. The loess regression line is weighted by population; circle areas are proportional to population for each occupation. Notice that, when occupations are reduced to combined groupings, almost identical trends are observed: see Figure~\ref{fig:meanocc2}. Sources: ABS cat 2072.0, O*NET, US Dept of Labor.}
