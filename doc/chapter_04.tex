...
\begin{figure}
  ...
  \caption{Change in wage share against change in: (1) log ICT electrical and electronic equipment capital ratio, (2) change in log ICT software capital ratio, (3) change in log ICT computers and peripherals capital ratio, by industry, Australia, 1996-2010.
    Fitted line computed using LOESS regression and 95\% confidence interval. See note for Table~\ref{tbl:reg} for more details.
  }
  \label{fig:equip}
\end{figure}
